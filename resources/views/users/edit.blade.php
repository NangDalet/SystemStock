               ...
               <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <p class="small-text">keep it blank to use old password!</p>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="file" class="form-control" id="photo" name='photo' accept="image/jpeg, image/x-png,image/gif" onchange="preview(event)" >
                                <p style="margin-top:9px">
                                    <img src="{{$user->photo}}" alt="" width="120" id='img'>
                                </p>
                            </div>
                        </div>
                    </div>
